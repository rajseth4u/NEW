/*
 * Auto-generated by ./gen-verstrs.pl on Sun Apr  5 10:37:46 2020
 */
...
lsquic_get_alt_svc_versions (unsigned versions)
{
    ...
    versions &= ((1<<LSQVER_039)|(1<<LSQVER_043)|(1<<LSQVER_046));
...
lsquic_get_h3_alpns (unsigned versions)
{
    ...
    versions &= ((1<<LSQVER_039)|(1<<LSQVER_043)|(1<<LSQVER_046)|(1<<LSQVER_ID23)|(1<<LSQVER_ID24));
